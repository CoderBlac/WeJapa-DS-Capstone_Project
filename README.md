...
You can input 'python bikeshare_2.py' on your terminal to run this program. I use Anaconda's command prompt on a Windows 10 machine.
...
* [Python 3.8.5](https://www.python.org/) - The language used to develop this.
...
* [time](https://docs.python.org/3.8/library/time.html) - One of the libraries used for this.
